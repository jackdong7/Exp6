...
<%
        ...
        {   String driverName="com.mysql.jdbc.Driver";
            ...
            if(rs.next())
            {
                String sql1=("delete from course_info where c_id='"+no+"'");
                stmt.executeUpdate(sql1);
                String sql="INSERT into course_info(c_id,c_name,c_time,c_area,c_score,c_teacher)"+" values('"+no+"','"+name+"','"+time+"','"+area+"','"+score+"','"+teacher+"')";
