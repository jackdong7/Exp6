...
<%
    ...
    if(id!=null&&password!=null&&identity!=null){
        String sql="select * from Login_info where LoginName='"+id+"'";
        ResultSet rs=read.getRs(sql);
        if(!rs.next()){
            String sql2="INSERT into "+tableName+"(LoginName,LoginPassword,LoginIdentity)"+" values('"+id+"','"+password+"','"+identity+"')";
            write.write_in(sql2);
            %>
